  ...
  routes: [
    { path: '/login', component: LoginView },
    {
      ...
      children: [
        ...
        { path: 'stocktakes', component: () => import('./views/StocktakeView.vue'), meta: { auth: true, menu: true, title: '资产盘点', icon: 'Finished', roles: ['admin', 'asset_manager'], order: 17 } },
        ...
        { path: 'licenses', component: () => import('./views/LicensesView.vue'), meta: { auth: true, menu: true, title: '软件许可', icon: 'Stamp', roles: ['admin', 'asset_manager'], order: 19.8 } },
        ...
        { path: 'tasks', component: () => import('./views/TasksView.vue'), meta: { auth: true, menu: true, title: '任务运行中心', icon: 'Timer', roles: ['admin'], order: 49 } },
