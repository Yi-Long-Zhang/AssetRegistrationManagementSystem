...
import { Aim, ArrowDown, Connection, Expand, Fold, Menu, Monitor, Operation, Setting, Tickets, User } from '@element-plus/icons-vue'
...
const iconMap = { Aim, Connection, Monitor, Operation, Setting, Tickets, User }
