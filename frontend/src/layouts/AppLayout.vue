...
import { Aim, ArrowDown, Connection, Expand, Fold, Menu, Monitor, Operation, Setting, Stamp, Tickets, User } from '@element-plus/icons-vue'
...
const iconMap = { Aim, Connection, Monitor, Operation, Setting, Stamp, Tickets, User }
