...
import { Aim, ArrowDown, Expand, Fold, Menu, Monitor, Operation, Setting, Tickets, User } from '@element-plus/icons-vue'
...
const iconMap = { Aim, Monitor, Operation, Setting, Tickets, User }
